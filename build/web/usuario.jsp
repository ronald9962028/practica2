<%-- 
    Document   : usuario
    Created on : 22-03-2021, 11:50:15 PM
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-5">
                    <form action="procesa2" method="post">
                        <legend class="text-white text-center mt-5">REGISTRO DE USUARIOS</legend>
                          ...
                          <div class="mb-3">
                            ...
                            <input type="email" id="correo" name="correo" class="form-control" placeholder="Ingrese su curreo">
                          </div> 
